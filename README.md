...
Когда сборка инсталлятора завершена, в Telegram прилетает сообщение со ссылкой.
Это «бот-нотификатор» (пуш), а не интерактивный бот — отвечает ему сервер не нужен,
всё работает из GitHub Actions.

...
- `.github/workflows/check-and-build.yml` — раз в 6 часов проверяет upstream.
  Если вышел новый тег — собирает инсталлятор и кладёт в Releases. Также есть
  ручной запуск.
...
а вот собранные бинарники публично не редистрибьютьить. Этот билдер — для личного
пользования, как и [оригинальный](https://github.com/theguywhoslate/aseprite-builder).
Исходники тут — MIT.
